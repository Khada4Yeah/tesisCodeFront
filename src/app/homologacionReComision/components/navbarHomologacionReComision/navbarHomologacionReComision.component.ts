...
@Component({
  selector: 'app-navbarHomologacionReComision',
  templateUrl: './navbarHomologacionReComision.component.html',
  styleUrls: ['./navbarHomologacionReComision.component.css'],
})
export class NavbarHomologacionReComisionComponent implements OnInit {
  ...
  constructor(
    ...
    this.perfil_seleccionado = 'RESPONSABLE DE LA COMISIÓN';
