...
@Component({
  selector: 'app-navbarHomologacionCoMaterias',
  templateUrl: './navbarHomologacionCoMaterias.component.html',
  styleUrls: ['./navbarHomologacionCoMaterias.component.css'],
})
export class NavbarHomologacionCoMateriasComponent implements OnInit {
  ...
  constructor(
    ...
    this.perfil_seleccionado = 'COORDINADOR DE MATERIAS';
